...
from tool import flights_finder,hotels_finder
...
class Agent:
    def __init__(self):
        ...
        self._tools_llm = ChatGroq(temperature=0,groq_api_key=os.getenv("GROQ_API_KEY"),model_name="deepseek-r1-distill-llama-70b")
    ...
    def email_sender(self, state: AgentState):
        print('Sending email')
        email_llm = ChatGroq(temperature=0,groq_api_key=os.getenv("GROQ_API_KEY"),model_name="deepseek-r1-distill-llama-70b")  # Instantiate another LLM
